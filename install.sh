...
wget --no-check-certificate "https://raw.githubusercontent.com/alkhanet26/sync-jam-dengan-bug/main/release_ram.lua" -O /usr/lib/lua/luci/controller/release_ram.lua
